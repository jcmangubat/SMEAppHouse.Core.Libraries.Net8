...
using IPProxy = SMEAppHouse.Core.ScraperBox.Models.IPProxy;
using Rules = SMEAppHouse.Core.ScraperBox.FreeIPProxies.Rules;
    ...
    public static class Helper
    {
        ...
        public static bool TestIPProxy2(IPProxy proxy)
        {
            try
            {
                ...
                var content = SMEAppHouse.Core.ScraperBox.Helper.GetPageDocument(new Uri("http://example.com"), proxy.ToWebProxy(), null);
                sw.Stop();
        ...
        {
            var protHt = proxy.Protocol == SMEAppHouse.Core.ScraperBox.IPProxyRules.ProxyProtocolsEnum.HTTPS ? "https://" : proxy.Protocol == SMEAppHouse.Core.ScraperBox.IPProxyRules.ProxyProtocolsEnum.HTTP ? "http://" : "";
