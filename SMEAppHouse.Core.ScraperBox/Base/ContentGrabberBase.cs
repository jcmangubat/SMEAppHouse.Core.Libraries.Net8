...
namespace SMEAppHouse.Core.ScraperBox.Base
{
            ...
            where TCrawlerResult : ICrawlerResult
    {
        ...
        /// <summary>
        /// Fetch the data from the URL as binary data and convert that to base64. This assumes the image
        ...
        /// <summary>
        /// Waits asynchronously until the crawler is ready.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Raises the OnContentCrawlerGrabbing event.
        /// </summary>
        /// <param name="pageUrl"></param>
        protected virtual void OnGrabbing(string pageUrl)
        {
            OnContentCrawlerGrabbing?.Invoke(this, new EventHandlers.ContentCrawlerGrabbingEventArgs<TCrawlerOptions>(pageUrl, CrawlerOptions));
        }

        /// <summary>
        /// Raises the OnContentCrawlerDone event.
        /// </summary>
        /// <param name="pageUrl"></param>
        /// <param name="result"></param>
        protected virtual void OnDone(string pageUrl, TCrawlerResult result)
        {
            OnContentCrawlerDone?.Invoke(this, new EventHandlers.ContentCrawlerDoneEventArgs<TCrawlerResult>(pageUrl, result));
        }
    }
}
