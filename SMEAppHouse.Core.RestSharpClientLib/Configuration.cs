    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public virtual string BasePath {
            ...
            set {
                ...
                if(_apiClient != null) {
                    // RestSharp 112.x: Create new RestClient with RestClientOptions
        ...
        public virtual int Timeout
        {
            ...
            get 
            { 
                // RestSharp 112.x: Options.Timeout is TimeSpan
                var timeout = ApiClient.RestClient.Options?.Timeout;
                if (timeout.HasValue)
                {
            ...
            set 
            { 
                // RestSharp 112.x: Cannot modify Options after creation, store timeout value for reference
                // The actual timeout should be set when creating RestClient
                _timeout = value;
                // If ApiClient already exists, recreate it with new timeout
                if (_apiClient != null)
                {
                    var options = new RestClientOptions(_basePath ?? "https://graphhopper.com/api/1")
                    {
