...
using SMEAppHouse.Core.ScraperBox.Puppeteer.Models;
...
namespace SMEAppHouse.Core.ScraperBox.Puppeteer.Base
{
        ...
        IContentCrawlerViaPuppeteer<ICrawlerOptionsPuppeteer, ICrawlerResultPuppeteer>
    {
        ...
        public override ICrawlerResultPuppeteer GrabPage(string url)
        {
            ...
            var ccgEvArg = new SMEAppHouse.Core.ScraperBox.Base.EventHandlers.ContentCrawlerGrabbingEventArgs<ICrawlerOptionsPuppeteer>(url, CrawlerOptions);
