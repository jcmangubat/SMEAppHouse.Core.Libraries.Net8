...
public abstract class EntityConfigurationArchivable<TEntity, TPk> : IEntityConfiguration<TEntity, TPk>
    where TEntity : class, IEntityKeyedArchivable<TPk>
    where TPk : struct
{
    ...
    {
        SetupConventionalFields<TEntity>(entityBuilder, FieldsToIgnore, Archivable);
    }
    ...
    protected EntityConfigurationArchivable(ModelBuilder builder,
    ...
    protected EntityConfigurationArchivable(
        bool prefixEntityNameToId = false,
        bool prefixAltTblNameToEntity = false,
        string schema = "dbo",
        bool pluralizeTblName = true)
    ...
    /// <param name="schema"></param>
    /// <param name="pluralizeTblName"></param>
    protected EntityConfigurationArchivable(string pluralTableName = ""
        , bool prefixEntityNameToId = false
        , bool prefixAltTblNameToEntity = false
        , string schema = "dbo"
        , bool pluralizeTblName = true)
    ...
    /// <param name="schema"></param>
    /// <param name="pluralizeTblName"></param>
    private EntityConfigurationArchivable(string pluralTableName = ""
        , bool prefixEntityNameToId = false
        , bool prefixAltTblNameToEntity = false
        , string preferredPKeyId = "Id"
        , string schema = "dbo"
    ...
    private static void SetupConventionalFields<T>(EntityTypeBuilder<TEntity> entityBuilder, Expression<Func<TEntity, object>>[] conventionFieldsToIgnore, bool archivable = false)
        where T : class, IEntityKeyedArchivable<TPk>
    {
